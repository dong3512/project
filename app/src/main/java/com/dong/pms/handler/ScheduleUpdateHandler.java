...
public class ScheduleUpdateHandler extends AbstractScheduleHandler{

  private MemberValidatorHandler memberValidatorHandler;

  public ScheduleUpdateHandler(List<Schedule> scheduleList, MemberValidatorHandler memberValidatorHandler) {
    super(scheduleList);
